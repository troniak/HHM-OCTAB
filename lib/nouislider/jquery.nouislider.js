...
// Event handlers
	...
	// give handles a random color
		/*function handles_rand_color (  ) {
		...
		function create ( options ) {
			...
			return this.each(function(){
				...
				for (i = 0; i < options['handles']; i++ ) {
                    ...
                    var innerHtml = [
                        '<style>',
                        '.color_'+color+' { background: #' + color + '; }',
                        '.color_'+color+'_connect'+' { background: #' + color + '; }',
                        '</style>'].join(' ');
                    var style = $(innerHtml)
